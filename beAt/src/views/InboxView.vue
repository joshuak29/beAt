<template>
  <main class="w-full py-4 flex flex-col items-center p-4">
    ...
    <form
      ...
      <!-- search input -->
      <input type="text" placeholder="Search" class="h-full grow bg-brand-platinum text-gray-500 text-xl pl-2" v-model="searchTerm">
